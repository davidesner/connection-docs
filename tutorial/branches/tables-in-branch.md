...
{: .image-popup}
![Screenshot - Create Development Branch](/tutorial/branches/08-create-dev-branch.png)

Name your new development branch, for example, *My dev branch*, and click **Create Development Branch**  to open it.

{: .image-popup}
![Screenshot - Name Development Branch](/tutorial/branches/09-name-dev-branch.png)

Your new branch will appear right below the name of your production project.

{: .image-popup}
![Screenshot - Created Development Branch](/tutorial/branches/10-dev-branch-created.png)
...
{: .image-popup}
![Mapping in branch](/tutorial/branches/mapping-in-branch.png)
...
{: .image-popup}
![Extractor output](/tutorial/branches/extractor-output.png)
...
{: .image-popup}
![Extractor output](/tutorial/branches/dev-branch-storage.png)
...
{: .image-popup}
![Storage explorer in production](/tutorial/branches/storage-dev-buckets.png)
...
{: .image-popup}
![Input mapping from branch data](/tutorial/branches/input-mapping-from-branch.png)
...
{: .image-popup}
![Input mapping from branch data](/tutorial/branches/transformation-branch-input-mapping.png)
...
{: .image-popup}
![Input mapping from branch data](/tutorial/branches/transformation-branch-input-mapping-missing.png)
...
{: .image-popup}
![Input mapping from branch data](/tutorial/branches/output-mapping-branch-transformation.png)

Run the updated transformation and examine the results.

{: .image-popup}
![Input mapping from branch data](/tutorial/branches/transformation-branch-output.png)
